...
ThemeData dark = ThemeData(
  primaryColor: const Color(0xFF0070CD),
  brightness: Brightness.dark,
  highlightColor: const Color(0xFF444039),
  buttonTheme: const ButtonThemeData(buttonColor:Color(0xFF1455AC) ),
  hintColor: const Color(0xFFc7c7c7),
  cardColor: const Color(0xFF242424),
  scaffoldBackgroundColor: const Color(0xFF444039),
